...
LearnOpenGL_LargerMap::LearnOpenGL_LargerMap() :
        ...
        current_window(nullptr)
{
    float Vertices[] = {
        // Front vertices
        -50.f, -50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 0.f,  // 0: front-bottom-left
         50.f, -50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 0.f,  // 1: front-bottom-right
         50.f,  50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 1.f,  // 2: front-top-right
        -50.f,  50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 1.f,  // 3: front-top-left

        // Back vertices
         50.f, -50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 0.f,  // 4: back-bottom-left
        -50.f, -50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 0.f,  // 5: back-bottom-right
        -50.f,  50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 1.f,  // 6: back-top-left
         50.f,  50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 1.f,  // 7: back-top-right

        // Right vertices
        50.f, -50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 0.f,  // 8: right-bottom-left
        50.f, -50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 0.f,  // 9: right-bottom-right
        50.f,  50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 1.f,  // 10: right-top-right
        50.f,  50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 1.f,  // 11: right-top-left

        // Left vertices
        -50.f, -50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 0.f,  // 12: left-bottom-left
        -50.f, -50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 0.f,  // 13: left-bottom-right
        -50.f,  50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 1.f,  // 14: left-top-right
        -50.f,  50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 1.f,  // 15: left-top-left

        // Top vertices
        -50.f,  50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 0.f,  // 16: top-bottom-left
        -50.f,  50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 0.f,  // 17: top-bottom-right
         50.f,  50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 1.f,  // 18: top-top-right
         50.f,  50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 1.f,  // 19: top-top-left

        // Bottom vertices
        -50.f, -50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 0.f,  // 20: bottom-bottom-left
        -50.f, -50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 0.f,  // 21: bottom-bottom-right
         50.f, -50.f, -50.f,    1.f, 0.f, 0.f, 1.f,    1.f, 1.f,  // 22: bottom-top-right
         50.f, -50.f,  50.f,    1.f, 0.f, 0.f, 1.f,    0.f, 1.f   // 23: bottom-top-left
    };
    ...
    ProceduralGenerate(5, 5, 4, true,
                       Vertices, sizeof(Vertices) / (VERTEX_COMPONENTS * sizeof(Vertices[0])), VERTEX_COMPONENTS,
                       Indices, sizeof(Indices) / sizeof(Indices[0]),
                       100.05f, vertex_buffer, index_buffer);

    float* vb = vertex_buffer.data();
    unsigned int* ib = index_buffer.data();

    /* Buffers */
    m_VAO = make_unique<VertexArray>();
    m_VBO = make_unique<VertexBuffer>(vertex_buffer.size() * sizeof(float), vb, GL_STATIC_DRAW);
    m_IBO = make_unique<IndexBuffer>(index_buffer.size(), ib, GL_STATIC_DRAW);
...
void LearnOpenGL_LargerMap::OnUpdate(float delta_time) {
}

void LearnOpenGL_LargerMap::OnRender() {
    ...
    if (current_window) {
        if (glfwGetKey(current_window, GLFW_KEY_SPACE) == GLFW_PRESS) {
            ...
            glfwSetCursorPosCallback(current_window, [](GLFWwindow *window, double mouse_position_x, double mouse_position_y) {
                auto app = static_cast<LearnOpenGL_LargerMap *>(glfwGetWindowUserPointer(window));
                if (app) {
...
void LearnOpenGL_LargerMap::OnImGuiRender() {
...
void LearnOpenGL_LargerMap::ConfigKeyboardInput(GLFWwindow *window) {
...
void LearnOpenGL_LargerMap::ConfigMouseInput(GLFWwindow* window, double mouse_position_x, double mouse_position_y) {
    if (m_FirstTouch)
    {
...
void LearnOpenGL_LargerMap::ConfigScrollInput(GLFWwindow* window, double scroll_offset_x, double scroll_offset_y) {
...
void LearnOpenGL_LargerMap::ProceduralGenerate(unsigned int width, unsigned int depth, unsigned int height, bool is_hollow,
                                               float vertices[], unsigned int num_vertices, unsigned int num_vertex_data,
                                               unsigned int indices[], unsigned int count_indices,
                                               float spacing, vector<float>& vbo, vector<unsigned int>& ibo) {
    unsigned int index_offset = 0;

    for (int y = 0; y < height; ++y) {
        for (int z = 0; z < depth; ++z) {
            for (int x = 0; x < width; ++x) {
                if (y >= 0 && y <= 1 && z == 4 && x == 2) continue;
                if (is_hollow) if (y < (height-1) & x > 0 && x < (width-1) && z > 0 && z < (depth-1)) continue;
