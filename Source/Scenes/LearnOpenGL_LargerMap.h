...
#define VERTEX_COMPONENTS (POSITION_COMPONENTS + COLOR_COMPONENTS + TEXCOORD_COMPONENTS)

class LearnOpenGL_LargerMap : public Scene {
public:
    LearnOpenGL_LargerMap();
...
private:
    ...
    static void ProceduralGenerate(unsigned int width, unsigned int depth, unsigned int height, bool is_hollow,
